...
class Keyboard(Backend):
    ...
    def __init__(self, experiment, **resp_args):
        r"""Constructor to create a new `Keyboard` object. You do not generally
        ...
        **resp_args : dict
            Optional [response keywords](#response-keywords) (`timeout` and
            `keylist`) that will be used as the default for this `Keyboard`
            object.
    ...
    def get_mods(self):
        r"""Returns a list of keyboard moderators (e.g., shift, alt, etc.) that
    ...
    def valid_keys(self):
        r"""Tries to guess which key names are accepted by the back-end. For
        internal use.
    ...
    def synonyms(self, key):
        r"""Gives a list of synonyms for a key, either codes or names. Synonyms
    ...
    def flush(self):
        r"""Clears all pending keyboard input, not limited to the keyboard.
    ...
    def show_virtual_keyboard(self, visible=True):
        ...
        visible : bool, optional
            True if the keyboard should be shown, False otherwise.
