...
class check_syntax(unittest.TestCase):
    ...
    def runTest(self):
        ...
        # As of OpenSesame 4.0, conditional expressions that don't contain
        # variable references, always, or never, are no longer compiled and
        # thus quotes are no longer added.
