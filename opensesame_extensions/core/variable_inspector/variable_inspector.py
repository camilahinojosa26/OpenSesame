...
from .variable_inspector_dockwidget import VariableInspectorDockWidget
from qtpy import QtCore, QtGui, QtWidgets
from libqtopensesame.misc.translate import translation_context
_ = translation_context(u'variable_inspector', category=u'extension')


class VariableInspector(BaseExtension):

    def event_startup(self):
        self.need_refresh = False
        self.dock_widget = VariableInspectorDockWidget(
